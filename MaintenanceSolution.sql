...
DECLARE @BackupDirectory nvarchar(max)     = N'F:\SQLLOG\LOG1\SQLBACKUP'        -- Specify the backup root directory. If no directory is specified, the default backup directory is used.
